...
use App\Entity\CompetencePersonnage;
...
class CompetencePersonnageRepository extends ServiceEntityRepository
{
    ...
    public function save(CompetencePersonnage $entity, bool $flush = false): void
    {
    ...
    public function remove(CompetencePersonnage $entity, bool $flush = false): void
    {
