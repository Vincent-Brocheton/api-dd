...
use App\Entity\RaceTrait;
use Doctrine\Bundle\DoctrineBundle\Repository\ServiceEntityRepository;
use Doctrine\Persistence\ManagerRegistry;

/**
 * @extends ServiceEntityRepository<RaceTrait>
 *
...
class RaceTraitRepository extends ServiceEntityRepository
{
    ...
    {
        parent::__construct($registry, RaceTrait::class);
    }

    public function save(RaceTrait $entity, bool $flush = false): void
    {
    ...
    public function remove(RaceTrait $entity, bool $flush = false): void
    {
